...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('monolithdemoApp.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/monolithdemoApp.job.delete.question/);
