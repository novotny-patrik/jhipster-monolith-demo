...
export class DepartmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('monolithdemoApp.department.delete.question'));
...
export default class DepartmentComponentsPage {
  ...
  async deleteDepartment() {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/monolithdemoApp.department.delete.question/);
