...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('monolithdemoApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/monolithdemoApp.task.delete.question/);
