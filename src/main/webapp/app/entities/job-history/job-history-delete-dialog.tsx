...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monolithdemoApp.jobHistory.delete.question">
        <Translate contentKey="monolithdemoApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
