...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monolithdemoApp.department.delete.question">
        <Translate contentKey="monolithdemoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
