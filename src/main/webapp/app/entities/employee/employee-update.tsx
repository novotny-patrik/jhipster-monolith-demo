  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="monolithdemoApp.employee.home.createOrEditLabel">
            <Translate contentKey="monolithdemoApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="firstNameLabel" for="employee-firstName">
                  <Translate contentKey="monolithdemoApp.employee.firstName">First Name</Translate>
                </Label>
                <AvField id="employee-firstName" type="text" name="firstName" />
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="monolithdemoApp.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
                <Label id="lastNameLabel" for="employee-lastName">
                  <Translate contentKey="monolithdemoApp.employee.lastName">Last Name</Translate>
                </Label>
                <AvField id="employee-lastName" type="text" name="lastName" />
              </AvGroup>
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="monolithdemoApp.employee.email">Email</Translate>
                </Label>
                <AvField id="employee-email" type="text" name="email" />
              </AvGroup>
              <AvGroup>
                <Label id="phoneNumberLabel" for="employee-phoneNumber">
                  <Translate contentKey="monolithdemoApp.employee.phoneNumber">Phone Number</Translate>
                </Label>
                <AvField id="employee-phoneNumber" type="text" name="phoneNumber" />
              </AvGroup>
              <AvGroup>
                <Label id="hireDateLabel" for="employee-hireDate">
                  <Translate contentKey="monolithdemoApp.employee.hireDate">Hire Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="monolithdemoApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="monolithdemoApp.employee.manager">Manager</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="monolithdemoApp.employee.department">Department</Translate>
                </Label>
